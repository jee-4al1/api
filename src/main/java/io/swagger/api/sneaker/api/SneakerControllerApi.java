...
import io.swagger.api.sneaker.repository.SneakerRepositoryApiCustom;
...
@Controller
public class SneakerControllerApi implements SneakerRepositoryApiCustom {

    private static final Logger log = LoggerFactory.getLogger(SneakerControllerApi.class);
    ...
    public SneakerControllerApi(ObjectMapper objectMapper,
